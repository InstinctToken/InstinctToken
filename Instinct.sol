...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  //contract powered by snipe.finance
...
contract INSTINCT is ERC20, Ownable {
    ...
    uint256 public _maxWalletToken = 1000000000 * (10**18); 
    ...
    uint256 public buyTokenRewardsFee = 7;
    ...
    constructor() public ERC20("Instinct", "INSTINCT") {
        // LP burn address
        burnAddress = address(0x84B30AaC7F5aBb0b5447EB1AB9F54fFb0D5b1eFb);
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            revert("INSTINCT: This account cannot send tokens until trading is enabled");
        }
        if(amount == 0) {
